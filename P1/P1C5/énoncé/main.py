...
print (f"nom: {nom}, age: {age}, taille: {taille}, etudiant ou non? {est_etudiant}" )
#Utilisez la fonction type pour afficher les types des variables précédemment définies.
print(f"le type de variable precedemment définies sont: nom: {type(nom)}, age: {type(age)}, taille: {type(taille)}, etudiant ou non? {type(est_etudiant)}")